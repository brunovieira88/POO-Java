...
public class CalendarDesafio {
    private int year, firstWeekday;
    private List<List<Integer>> events;

    //construtor
    public CalendarDesafio(int year){
        LocalDate date = LocalDate.of(year, 1, 1);
        DayOfWeek firstWeekday = date.getDayOfWeek();
        int firstWeekdayNum = firstWeekday.getValue();
        this.firstWeekday = firstWeekdayNum;
        this.year = year;
    ...
    public static void main(String[] args) {
        CalendarDesafio calendar = new CalendarDesafio(2024); 
